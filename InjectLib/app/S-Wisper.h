...
typedef struct _UNICODE_STRING_A
{
	USHORT Length;
	USHORT MaximumLength;
	PWSTR  Buffer;
} UNICODE_STRINGA, *PUNICODE_STRINGA;

typedef struct _OBJECT_ATTRIBUTES_A
{
	ULONG           Length;
	HANDLE          RootDirectory;
	UNICODE_STRINGA ObjectName;
	ULONG           Attributes;
	PVOID           SecurityDescriptor;
	PVOID           SecurityQualityOfService;
} OBJECT_ATTRIBUTESA, *POBJECT_ATTRIBUTESA;
